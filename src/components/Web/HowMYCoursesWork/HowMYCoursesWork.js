  ...
  return (
    <Row className="how-my-courses">
      <Col lg={24} className="how-my-courses__title">
        ...
        <h3>
          Cada curso estarán activos las 24 horas del dia, una vez comprado
      ...
      <Col lg={16}>
        ...
        <Row className="row-cards">
          <Col md={8}>
            <CardInfo
              Icon={UserOutlined}
              title="Mejrora tu perfil de trabajo"
              description="Aprende y mejora tu perfil para mantenerte informado de actualizaciones y a la banguardia de tu hoja de vida. "
            />
          </Col>
          <Col md={8}>
            <CardInfo
